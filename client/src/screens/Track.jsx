    ...
    start = () => {
        ...
        let myVar = setInterval(() => {
            if (i > 2000) {
                ...
                this.setState({bColor: 'white'})
                this.setState({cColor: 'white'})
                this.setState({dColor: 'white'})
                this.setState({eColor: 'white'})
                this.setState({fColor: 'white'})
                this.setState({gColor: 'white'})
                this.setState({hColor: 'white'})
                this.setState({iColor: 'white'})
                this.setState({jColor: 'white'})
                this.setState({kColor: 'white'})
                this.setState({lColor: 'white'})
                this.setState({mColor: 'white'})
                this.setState({nColor: 'white'})
                this.setState({oColor: 'white'})
                this.setState({pColor: 'white'})
                this.setState({qColor: 'white'})
                this.setState({rColor: 'white'})
                this.setState({sColor: 'white'})
                this.setState({tColor: 'white'})
                this.setState({uColor: 'white'})
            }
            if (timeline[i]) {
